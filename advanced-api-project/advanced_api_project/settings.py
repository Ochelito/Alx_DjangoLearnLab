...
SECRET_KEY = 'django-insecure-%%=)&d3(ljp5t8@)sr=rhvsezyky8xo*=7ngx)h&kxe7k=&8h8'
...
INSTALLED_APPS = [
    ...
    'django-filter', # Django Filter for filtering querysets in APIs
]

#Set default backend for all views
REST_FRAMEWORK = {
