...
class BookListView(generics.ListAPIView):
    ...
    permission_classes = [IsAuthenticatedOrReadOnly, IsAuthorOrReadOnly]  # Allow unauthenticated users to view the list of books
...
class BookDetailView(generics.DetailAPIView):
    queryset = Book.objects.all()
    serializer_class = BookSerializer
    permission_classes = [IsAuthenticatedOrReadOnly, IsAuthorOrReadOnly]  # Allow unauthenticated users to view book details
